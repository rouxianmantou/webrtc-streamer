...
std::map<std::string, std::string> getV4l2AlsaMap()
{
	...
	std::cout << "****** ****** ****** ****** ****** ****** v_device" << std::endl;
	for (auto &v_device : videodevices)
	{
		std::cout << "GHL-TEST: " << v_device.first << ":" << v_device.second << std::endl;
	}
	std::cout << "****** ****** ****** ****** ****** ****** a_device" << std::endl;
	for (auto &a_device : audiodevices)
	{
		std::cout << "GHL-TEST: " << a_device.first << ":" << a_device.second << std::endl;
	}
